...
//  });
 ...
 $(".owl-carousel").owlCarousel();
    ...
    //    var productCount = $("#pro-count").val();
    //    $.ajax({
    //        url: "Categories?skip="+skipCount,
    //        type: "GET",
    //        success: function (response) {
    //            console.log(response);
    //            //$("#load-product").append(response);
    //            //skipCount += 4;
    ...
    //Search
    $("#customerNameSearchTextbox").keyup(function () {
        $("#customerNameUL").empty();
        var src = $(this).val();
        if (src.length > 1) {
            $.ajax({
                url: "Home/Search?str=" + src,
                type: "GET",
                success: function (response) {
                    //console.log(response);
                    $("#customerNameUL").append(response);
    ...
    $("#More").click(function () {
        ...
        $.ajax({
            url: "CategoryAside?categoryid="+cateid+"skip=" + skipCount,
            type: "GET",
            success: function (response) {
               console.log(cateid);
